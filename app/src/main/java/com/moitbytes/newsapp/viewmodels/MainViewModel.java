package com.moitbytes.newsapp.viewmodels;
...
import com.moitbytes.newsapp.model.TotalNews;
import com.moitbytes.newsapp.restapi.ApiClient;
import com.moitbytes.newsapp.restapi.RestInterface;
...
public class MainViewModel extends ViewModel {
    ...
    private void getNews(String langCode, String category) {
        ...
        {
            call = restInterface.getSearchedTotalNews("Covid", apiKey);
        }
